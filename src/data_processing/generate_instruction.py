...
def post_process_gpt3_response(num_prompt_instructions, response):
    ...
    for idx, inst in enumerate(raw_instructions):
        ...
        # if len(inst.split()) <= 3 or len(inst.split()) > 100:
        #     continue
...
def generate_instruction_following_data(
    ...
    while cnt < num_instructions_to_generate:
        request_idx += 1
        batch_inputs = []
        ...
        # 写到json文件，一行一个数据
        with open(os.path.join(output_dir, "regen.json"), mode='a', encoding='utf-8') as f:
