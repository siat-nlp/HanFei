...
def convert_zero_checkpoint_to_fp32_state_dict(checkpoint_dir, output_file, tag=None):
    ...
    for name in state_dict:
        new_state_dict[name.replace('module.model.', '')] = state_dict[name]
    if new_state_dict['lm_head.weight'].size() == torch.Size([0]):
        print("Copy weights from transformer.word_embeddings.weight to lm_head.weight.")
